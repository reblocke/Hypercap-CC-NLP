...
def _classifier_join_key_columns(df: pd.DataFrame) -> list[str]:
    ...
    return [column for column in ("ed_stay_id", "hadm_id", "subject_id") if column in df.columns]
...
def write_classifier_candidate_sidecars(
    ...
    *,
    ...
    visit_path = output_dir / "visit_candidate_scores.csv"
    segment_path = output_dir / "segment_candidate_scores.csv"
