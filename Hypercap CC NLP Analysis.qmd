...
prevalence_label_map = {
    ...
    "pco2_threshold_0_24h": "PCO2 threshold within 24h",
}
cohort_n = int(len(df))
hypercap_prevalence = (
    pd.DataFrame(
...
icd_positive_breakdown = pd.DataFrame(
    {
        ...
        "Count": [
            ...
            int(icd_positive_df["pco2_threshold_0_24h"].sum()),
        ],
    }
)
if icd_positive_n > 0:
...
display(crosstab_tables["pco2_threshold_0_24h"].head(10))
...
gas_flag = to_binary_flag(df["pco2_threshold_0_24h"])
...
print("Symptom distribution by ABG/VBG/UNKNOWN overlap (expanded output):")
...
performance_targets = [
    ("pco2_threshold_0_24h", "Gas 0-24h"),
