...
def test_load_and_validate_artifacts_invalid_json_is_hard_fail(tmp_path: Path) -> None:
    ...
    (cohort_qa_dir(tmp_path) / "qa_summary.json").write_text("{not-json")
