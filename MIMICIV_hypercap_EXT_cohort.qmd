...
POC_QC_PO2_CONTAM_P50_MIN = 75.0
POC_QC_PO2_CONTAM_P25_MIN = 60.0
...
META = {
    ...
    "pco2_threshold_0_24h": {
        ...
        "source": "Derived",
        "derivation": "pco2_threshold_any == 1 and dt_first_qualifying_gas_hours <= 24",
        "units": "binary (0/1)",
    },
    "qualifying_pco2_time": {
    ...
    "first_gas_time": {
        ...
        "definition": "Earliest qualifying hypercapnic gas time across the admission stay.",
        "source": "mimiciv_hosp.labevents + mimiciv_icu.chartevents",
    ...
    "dt_first_qualifying_gas_hours": {
        ...
        "definition": "Hours from ED presentation anchor to first qualifying hypercapnic blood gas.",
        "source": "Derived",
        "derivation": "(qualifying_pco2_time - presentation anchor) in hours; values may exceed 24",
        "units": "hours",
    },
    "first_other_time": {
