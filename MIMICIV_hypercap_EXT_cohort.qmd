...
-   **Canonical outputs:**
    ...
    -   `qa_summary.json [ ] TODO this contains?`
...
SRC_DIR = WORK_DIR / "src"  # Local helper package path for contracts/audit utilities.
...
gas_source_diagnostics_artifact_path = artifacts_dir / "gas_source_diagnostics_by_ed_stay.csv"
...
qa_payload["qa_scope_notes"] = {
    ...
    "secondary_summary_path": "debug/qa/qa_summary_ed_spine.json",
}
