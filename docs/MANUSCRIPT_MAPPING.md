...
|---|---|---|
| Figure 1: analytic cohort construction and NLP workflow | `Hypercap CC NLP Analysis.qmd` | `Results/YYYY-MM-DD/Figure 1.pdf` |
| Figure 2: presenting-concern prevalence by ascertainment route | `Hypercap CC NLP Analysis.qmd` | `Results/YYYY-MM-DD/Figure 2.pdf`, `Figure 2.xlsx` |
